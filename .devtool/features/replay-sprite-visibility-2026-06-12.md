...
- 2026-06-12 — **verify** — Task 6 Step 6.3 (CP-3): harvest canvas delete — `buildCanvasPaintPlan` + preload + terrain filter always paint-plan authority (flag-independent canvas); removed `stageCell`, harvest carry/preload loops; legacy DOM/`labSpriteRelpathForCell` retained; gate **35/35** pytest
