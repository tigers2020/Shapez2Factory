...
class ExtensionAttachment:
    """Canonical-E parent→child extension edge (offsets relative to extractor at origin)."""
...
def extension_attachments_parent_first(
    ...
    """Topological order: parent extension before child (matches port-rotation DFS)."""
