"""Solver HTTP JSON endpoints that inject web-layer adapters (graph preview, etc.)."""
...
def solve_shape(request: HttpRequest) -> JsonResponse:
    ...
    payload = serialize_solver_result(result, warnings=tuple(warnings), preview_renderer=renderer)
