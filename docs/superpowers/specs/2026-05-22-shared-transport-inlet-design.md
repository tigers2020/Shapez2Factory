...
BAD:  Miner C sets fixed_output_transport on a cell already used as transport
      → blocks “inward” injection for existing feeders (최악의 수)
```
...
- [`phase_j_incremental_commit.md`](../../../documents/Algorithm/solver_runtime/phase_j_incremental_commit.md) Route sharing bullet “same cell sharing 금지” **contradicts** this spec → **update doc** to match v0.
