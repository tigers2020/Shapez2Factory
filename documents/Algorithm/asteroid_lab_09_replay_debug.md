...
**Sequence 13 전체 로드맵(13C–13G·불변·종료 조건):** [`asteroid_lab_13_replay_payload_scalability.md`](asteroid_lab_13_replay_payload_scalability.md)
...
**로드맵 정본(13C–13G·우선순위·비범위):** [`asteroid_lab_13_replay_payload_scalability.md`](asteroid_lab_13_replay_payload_scalability.md)
...
## Sequence 13 — Replay Payload Scalability (로드맵 정본)

13C 이후 **구현 순서·전략 역할 구분·비범위·테스트·종료 조건·승인 전 금지**는 아래 문서에 고정한다. 본 절의 13A·13B는 **계측·현장 증거·갭**의 상세 근거로 유지한다.

- [`asteroid_lab_13_replay_payload_scalability.md`](asteroid_lab_13_replay_payload_scalability.md)

**13C 코드·응답 계약·JS 로딩 변경은 명시적 승인 후** 별도 PR로만 진행한다.
