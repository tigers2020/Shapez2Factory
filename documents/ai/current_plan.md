...
- **ACTIVE:** RTTP v1 MacroBundleT3 spec — [`2026-05-23-rttp-v1-macrobundle-t3-design.md`](../../docs/superpowers/specs/2026-05-23-rttp-v1-macrobundle-t3-design.md) (draft; implementation plan TBD after approval)
- RTTP DB integration hardening (`run_solver` + `:rttp` on fixture project) — after v1 plan; lower priority than algorithm direction
