...
| Replay payload 13D-SSR | **CLOSED** — merged with [#131](https://github.com/tigers2020/Shapez2Factory/pull/131) · `master` `d0cf7603` · [`2026-05-29-replay-payload-13d-ssr-slim.md`](../../docs/superpowers/plans/2026-05-29-replay-payload-13d-ssr-slim.md) |
| Replay compose defer 13C2-lite | **CLOSED (2026-05-29)** — [#131](https://github.com/tigers2020/Shapez2Factory/pull/131) squash → `master` `d0cf7603` · spec [`2026-05-29-replay-compose-defer-artifact-reuse-design.md`](../../docs/superpowers/specs/2026-05-29-replay-compose-defer-artifact-reuse-design.md) §7.1 perf verification. **Follow-up:** 13G wire compression · 13E delta · `solver_runs_for_lab_project` query opt. |
