...
**CLOSED (2026-05-30):** **Track B — pass-capable slug certified:** `rttp-cert-candidate-tiny-passable-v2` — **borderline T2 pass** (`actual_committed=480`, `throughput_target_min=480`, margin 0); `validation_passed=true`, `issue_codes=[]`; cert `solver_run_id` **151**, Task 4 confirm **153**; `slug_class=pass_capable`. Registry: `RTTP_PASS_CAPABLE_SLUGS` in [`rttp_ops_policy.py`](../../django_apps/asteroid_lab/contracts/rttp_ops_policy.py). Reports: [`task4-confirm-v2.json`](../../docs/superpowers/reports/2026-05-30-rttp-pass-capable-slug-certification-task4-confirm-v2.json), [`task4-limit30.json`](../../docs/superpowers/reports/2026-05-30-rttp-pass-capable-slug-certification-task4-limit30.json) (`certified_pass_count=4`). Fixture SoT: [`rttp_tiny_passable_v2.code`](../../tests/fixtures/asteroid_lab/rttp_tiny_passable_v2.code). Spec: [`2026-05-30-rttp-pass-capable-slug-certification-design.md`](../../docs/superpowers/specs/2026-05-30-rttp-pass-capable-slug-certification-design.md). **Track A not opened.**
