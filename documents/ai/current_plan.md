...
**IMPLEMENTED (2026-05-30, uncommitted):** **D-PR — T2 diagnostic canon observability** — `rttp_ops_policy`, summary merge, runtime slug, Lab projection/JS, CLI line. Plan: [`docs/superpowers/plans/2026-05-30-rttp-throughput-policy-t2-diagnostic-canon.md`](../../docs/superpowers/plans/2026-05-30-rttp-throughput-policy-t2-diagnostic-canon.md). Spec: [`docs/superpowers/specs/2026-05-30-rttp-throughput-policy-t2-diagnostic-canon-design.md`](../../docs/superpowers/specs/2026-05-30-rttp-throughput-policy-t2-diagnostic-canon-design.md). Narrow gate: 40 policy-related unit tests PASS; `test_optimization_contamination.ps1` PASS. Canon ops readback pending post-merge `run_solver --slug copy-import-495e552c`.
