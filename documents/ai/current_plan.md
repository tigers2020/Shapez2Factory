...
**IN FLIGHT (2026-05-25):** PR-2c throughput target % (10–80) + real `throughput_budget_satisfied` + Lab slider/cards — PR [#80](https://github.com/tigers2020/Shapez2Factory/pull/80) (base PR #79 / PR-2b). Spec: [`docs/superpowers/specs/2026-05-24-throughput-target-percent-pr2c-design.md`](../../docs/superpowers/specs/2026-05-24-throughput-target-percent-pr2c-design.md).
