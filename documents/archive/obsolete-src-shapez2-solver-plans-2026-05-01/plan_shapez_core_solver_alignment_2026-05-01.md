...
> **Archived 2026-05-01.** Assumed `src/shapez2_solver/` as the primary boundary; active work follows `django_apps/shapez_core` and `django_apps/shapez_solver` per `AGENTS.md` / `architecture.mdc`.

## Basis

- Research: [`research_shapez_core_solver_plan_compatibility_2026-05-01.md`](./research_shapez_core_solver_plan_compatibility_2026-05-01.md)
- Input concept: [`shapez_core_solver_dev_plan.md`](../../meta/shapez_core_solver_dev_plan.md)
