...
> **Archived 2026-05-01.** Recommended `src/shapez2_solver` for solver logic; superseded by Django app boundaries under `django_apps/`.

- Date: 2026-05-01
- Scope: initial Django scaffold for the shapez2 factory planner.
- Source: [`../../meta/chat.md`](../../meta/chat.md) and the approved Cursor plan `django_scaffold_structure_2566eb51`.
