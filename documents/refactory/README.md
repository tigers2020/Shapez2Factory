...
|------|------|-------------|----------------|
| A | [control-flow-refactor.md](./control-flow-refactor.md) | §4.3 복귀·오케스트레이터·attempt 분리 | 02, [epic_a_control_flow_mini_audit.md](./epic_a_control_flow_mini_audit.md), [epic_a_mvp_exceptions.md](./epic_a_mvp_exceptions.md), [epic_a_implementation_scope.md](./epic_a_implementation_scope.md), [epic_a_active_rows.md](./epic_a_active_rows.md) |
...
4. **PlacementCommitState** — merged seed 예외·§9.6 (문서 **05**·[placement_fsm_mini_audit.md](./placement_fsm_mini_audit.md); Epic A/B와 순서 조율)
