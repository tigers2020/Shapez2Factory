...
|------|------|-------------|----------------|
| A | [control-flow-refactor.md](./control-flow-refactor.md) | §4.3 복귀·오케스트레이터·attempt 분리 | 02 |
...
**Phase 0 산출물(읽기 전용 drift matrix):** [phase0_drift_matrix.md](./phase0_drift_matrix.md)
