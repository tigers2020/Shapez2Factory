...
2. **B 분류 문서화:** `02_pipeline_recovery_control_flow.md` 또는 정본 저장소에 **MVP 구현 매핑** 절을 추가해 `step4_*`·`final_validation_failure`·`pass3_connectivity_break`의 **B** 근거를 한 페이지에 고정한다.  
