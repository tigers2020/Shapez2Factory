...
- Target document: `documents/shapez_core_solver_dev_plan.md`
...
- `documents/shapez_core_solver_dev_plan.md`
...
`documents/shapez_core_solver_dev_plan.md` should not be executed as the active implementation plan for this repository.
