...
git add django_apps/asteroid_lab/replay/replay_cell_index.py \
  ...
  tests/unit/asteroid_lab/replay/test_replay_frame_cell_resolver.py \
  tests/unit/asteroid_lab/test_lab_canvas_renderer.py \
  documents/superpowers/specs/2026-06-12-replay-sprite-visibility-design.md \
  documents/superpowers/plans/2026-06-12-replay-sprite-visibility-slice-1.md
...
Plan saved to `documents/superpowers/plans/2026-06-12-replay-sprite-visibility-slice-1.md`.
