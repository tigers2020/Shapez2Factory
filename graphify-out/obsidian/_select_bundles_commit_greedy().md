...
# _select_bundles_commit_greedy()

## Connections
- [[BeamPenaltyWeights_1]] - `references` [EXTRACTED]
- [[BeamSelectionResult]] - `references` [EXTRACTED]
- [[CommitDomainState]] - `calls` [EXTRACTED]
- [[CommitReprobeContext]] - `references` [EXTRACTED]
- [[Coord]] - `references` [EXTRACTED]
- [[Global greedy under Phase D reprobe (throughput-first; full pool).]] - `rationale_for` [EXTRACTED]
...
- [[_finalize_selection_result()]] - `calls` [EXTRACTED]
- [[_respects_rim_platform()]] - `calls` [EXTRACTED]
- [[_select_bundles_rim_platform_commit()]] - `calls` [EXTRACTED]
- [[beam_selector.py]] - `contains` [EXTRACTED]
- [[select_bundles()]] - `calls` [EXTRACTED]
