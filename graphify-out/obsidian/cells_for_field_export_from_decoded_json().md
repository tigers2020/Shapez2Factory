...
- [[Import decoded blueprint then keep only asteroid field cells for game paste.]] - `rationale_for` [EXTRACTED]
- [[cells_for_field_export()]] - `calls` [EXTRACTED]
- [[load_reconstruction_cells_from_decoded_json()]] - `calls` [EXTRACTED]
