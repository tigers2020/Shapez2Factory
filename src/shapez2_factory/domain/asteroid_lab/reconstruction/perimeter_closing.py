...
from shapez2_factory.domain.asteroid_lab.reconstruction.shell import _strict_bbox_interior_cells
...
__all__ = ["close_diagonal_leaks", "close_orthogonal_one_cell_slits"]
