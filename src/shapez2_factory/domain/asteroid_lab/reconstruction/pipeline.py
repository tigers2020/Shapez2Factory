...
from shapez2_factory.domain.asteroid_lab.copy_json_coords import entries_have_explicit_raw_x_zero
...
from shapez2_factory.domain.asteroid_lab.reconstruction.flood_fill import external_reachable
from shapez2_factory.domain.asteroid_lab.reconstruction.grid import Coord, iter_bbox_cells
from shapez2_factory.domain.asteroid_lab.reconstruction.island import stamp_islands_uniform
from shapez2_factory.domain.asteroid_lab.reconstruction.perimeter_closing import (
