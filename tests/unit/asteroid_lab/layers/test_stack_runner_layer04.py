"""Stack runner wires L5 transport routing after L4 inner fill."""
...
def test_default_active_stack_includes_layer05_transport_slug() -> None:
    assert LAYER_05_TRANSPORT_ROUTING in LAYERS_02_TO_06_ACTIVE
    assert LAYER_04_INNER_PATTERN_FILL in LAYERS_02_TO_06_ACTIVE


def test_stack_runs_layer05_transport_after_l4_fill() -> None:
    captured: dict[str, Layer05RoutePlan] = {}
    ...
    def stub_l4(**_kwargs: object) -> object:
    ...
    def capture_l5(**kwargs: object) -> Layer05RoutePlan:
        plan = run_layer_05_transport_routing(**kwargs)
        captured["plan"] = plan
        return plan
    ...
    runners = (
        ...
        _LayerStackRunner(LAYER_04_INNER_PATTERN_FILL, stub_l4),
        _LayerStackRunner(LAYER_05_TRANSPORT_ROUTING, capture_l5),
    ...
    assert LAYER_05_TRANSPORT_ROUTING in core.stack_result.completed_layer_slugs
